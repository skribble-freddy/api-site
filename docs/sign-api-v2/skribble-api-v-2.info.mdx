...
description: "The Skribble API v2 documentation describes the publicly available Skribble"
...
<Export
  url={"https://skribble-freddy.github.io/api-doc/sign_api_v2.yaml"}
  proxy={undefined}
>
